...
**Read Time**  is a chrome it will add a small icon to your Chrome toolbar. To use it, simply click on the icon when you are on a webpage with an article you want to read. The extension will analyze the text on the page and calculate the approximate reading time based on the number of words.
